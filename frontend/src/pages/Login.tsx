...
const CLIENT_TYPES = [
  "Creative Agency", "PR Agency", "Advertising Agency", "Multi Channel Network",
  "Event Organizer", "Brand", "Corporates", "Governments", "Media",
  "Homeless Media", "Individual Users", "MSMEs", "NGOs",
  "Education Institutions", "Business Associations",
];
      ...
      <div className="flex-1 flex items-center justify-center p-4 sm:p-8">
        <div className="w-full max-w-[400px]">
          ...
          {!role ? (
            ...
            <>
              <button
                onClick={() => { setRole(null); setEmail(""); setPassword(""); setClientType(""); }}
                className="flex items-center gap-1.5 text-[12px] font-semibold mb-6 transition-colors"
                style={{ color: "var(--ch-text-muted)" }}
                onMouseEnter={(e) => { e.currentTarget.style.color = "var(--ch-text)"; }}
                onMouseLeave={(e) => { e.currentTarget.style.color = "var(--ch-text-muted)"; }}
              >
                ← Back
              </button>
              ...
              {role === "client" && (
                <div className="mb-4">
                  <label className="text-[12px] font-semibold block mb-1.5" style={{ color: "var(--ch-text-muted)" }}>
                    Client Type
                  </label>
                  <select
                    value={clientType}
                    onChange={(e) => setClientType(e.target.value)}
                    className="w-full px-3 py-2 text-[13px] font-semibold rounded-lg border cursor-pointer"
              ...
              <div className="mt-6 pt-5 border-t text-center" style={{ borderColor: "var(--ch-border)" }}>
                {role === "creator" ? (
                  ...
                  <p className="text-[13px]" style={{ color: "var(--ch-text-muted)" }}>
                    ...
                    <a href="mailto:hello@creatorhub.id" style={{ color: "var(--ch-primary)", fontWeight: 600 }}>
                      Hubungi kami →
                    </a>
                  </p>
                )}
