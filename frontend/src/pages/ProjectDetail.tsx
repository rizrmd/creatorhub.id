...
const TikTokLogo = ({ size = "w-3.5 h-3.5" }: { size?: string }) => (
  <svg viewBox="0 0 24 24" className={`${size} fill-white`}><path d="M12.525.02c1.31-.02 2.61-.01 3.91-.02.08 1.53.63 3.09 1.75 4.17 1.12 1.11 2.7 1.62 4.24 1.79v4.03c-1.44-.05-2.89-.35-4.2-.97-.57-.26-1.1-.59-1.62-.93-.01 2.92.01 5.84-.02 8.75-.08 1.4-.54 2.79-1.35 3.94-1.31 1.92-3.58 3.17-5.91 3.21-1.43.08-2.86-.31-4.08-1.03-2.02-1.19-3.44-3.37-3.65-5.71-.02-.5-.03-1-.01-1.49.18-1.9 1.12-3.72 2.58-4.96 1.66-1.44 3.98-2.13 6.15-1.72.02 1.48-.04 2.96-.04 4.44-.99-.32-2.15-.23-3.02.37-.63.41-1.11 1.04-1.36 1.75-.21.51-.15 1.07-.14 1.61.24 1.64 1.82 3.02 3.5 2.87 1.12-.01 2.19-.66 2.77-1.61.19-.33.4-.67.41-1.06.1-1.79.06-3.57.07-5.36.01-4.03-.01-8.05.02-12.07z"/></svg>
);
const InstaLogo = ({ size = "w-3.5 h-3.5" }: { size?: string }) => (
  <svg viewBox="0 0 24 24" className={`${size} fill-white`}><path d="M12 2.163c3.204 0 3.584.012 4.85.07 3.252.148 4.771 1.691 4.919 4.919.058 1.265.069 1.645.069 4.849 0 3.205-.012 3.584-.069 4.849-.149 3.225-1.664 4.771-4.919 4.919-1.266.058-1.644.07-4.85.07-3.204 0-3.584-.012-4.849-.07-3.26-.149-4.771-1.699-4.919-4.92-.058-1.265-.07-1.644-.07-4.849 0-3.204.013-3.583.07-4.849.149-3.227 1.664-4.771 4.919-4.919 1.266-.057 1.645-.069 4.849-.069zM12 0C8.741 0 8.333.014 7.053.072 2.695.272.273 2.69.073 7.052.014 8.333 0 8.741 0 12c0 3.259.014 3.668.072 4.948.2 4.358 2.618 6.78 6.98 6.98C8.333 23.986 8.741 24 12 24c3.259 0 3.668-.014 4.948-.072 4.354-.2 6.782-2.618 6.979-6.98.059-1.28.073-1.689.073-4.948 0-3.259-.014-3.667-.072-4.947-.196-4.354-2.617-6.78-6.979-6.98C15.668.014 15.259 0 12 0zm0 5.838a6.162 6.162 0 100 12.324 6.162 6.162 0 000-12.324zM12 16a4 4 0 110-8 4 4 0 010 8zm6.406-11.845a1.44 1.44 0 100 2.881 1.44 1.44 0 000-2.881z"/></svg>
);
const LogoCircle = ({ bg, children, size = "w-6 h-6" }: { bg: string; children: React.ReactNode; size?: string }) => (
  <span className={`${size} rounded-full flex items-center justify-center shrink-0`} style={{ background: bg }}>{children}</span>
);
            ...
            <div className="flex-1 p-5 overflow-auto">
              ...
              {activeSubTab === "skema" && (
                <div className="space-y-3">
                  ...
                  {/* Tim Humas — full width */}
                  <div className="rounded-lg border p-3 text-center" style={{ borderColor: "var(--ch-border)", background: "var(--ch-surface)" }}>
                  ...
                  {/* Two columns: Left flowchart + Right Amplifications */}
                    ...
                    <div className="flex-1 space-y-2">
                        ...
                        <div className="grid grid-cols-3 gap-2">
                          {[
                            ...
                            <div className="flex items-center justify-center gap-1 mt-0.5">
                              {acc.name === "Menteri UMKM" && <><LogoCircle bg="linear-gradient(45deg, #f09433 0%, #e6683c 25%, #dc2743 50%, #cc2366 75%, #bc1888 100%)" size="w-3 h-3"><InstaLogo size="w-1.5 h-1.5" /></LogoCircle><span className="text-[7px] font-semibold" style={{ color: "#E1306C" }}>Instagram</span></>}
                              {acc.name === "Kementerian UMKM" && <><LogoCircle bg="linear-gradient(45deg, #f09433 0%, #e6683c 25%, #dc2743 50%, #cc2366 75%, #bc1888 100%)" size="w-3 h-3"><InstaLogo size="w-1.5 h-1.5" /></LogoCircle><span className="text-[7px] font-semibold" style={{ color: "#E1306C" }}>Instagram</span><LogoCircle bg="#000000" size="w-3 h-3"><TikTokLogo size="w-1.5 h-1.5" /></LogoCircle><span className="text-[7px] font-semibold" style={{ color: "#00F2EA" }}>TikTok</span></>}
                              {acc.name === "Wakil Menteri UMKM" && <><LogoCircle bg="linear-gradient(45deg, #f09433 0%, #e6683c 25%, #dc2743 50%, #cc2366 75%, #bc1888 100%)" size="w-3 h-3"><InstaLogo size="w-1.5 h-1.5" /></LogoCircle><span className="text-[7px] font-semibold" style={{ color: "#E1306C" }}>Instagram</span></>}
                            </div>
                      ...
                      <div className="grid grid-cols-3 gap-2">
                        ...
                        <div className="flex items-center gap-2 mb-2">
                          <LogoCircle bg="#000000"><TikTokLogo /></LogoCircle>
                          <LogoCircle bg="linear-gradient(45deg, #f09433 0%, #e6683c 25%, #dc2743 50%, #cc2366 75%, #bc1888 100%)"><InstaLogo /></LogoCircle>
                          <LogoCircle bg="#FF0000"><Youtube className="w-3.5 h-3.5" style={{ color: "#FFF" }} /></LogoCircle>
                          <p className="text-[11px] font-extrabold" style={{ color: "var(--ch-text)", fontFamily: "'Plus Jakarta Sans', sans-serif" }}>SHELTER (3)</p>
                          </div>
                          <div className="space-y-1.5">
                            {[
                              { handle: "jurnal.wargajakarta", followers: "123K", photo: "/profile-photos/jurnal-warga-jakarta.jpg", platform: "instagram" },
                            ...
                            <div key={s.handle} className="flex items-center gap-1.5 p-1.5 rounded border" style={{ borderColor: "var(--ch-border)" }}>
                              ...
                              {s.platform === "instagram" && <LogoCircle bg="linear-gradient(45deg, #f09433 0%, #e6683c 25%, #dc2743 50%, #cc2366 75%, #bc1888 100%)" size="w-5 h-5"><InstaLogo size="w-2.5 h-2.5" /></LogoCircle>}
                              {s.platform === "tiktok" && <LogoCircle bg="#000000" size="w-5 h-5"><TikTokLogo size="w-2.5 h-2.5" /></LogoCircle>}
                              {s.platform === "youtube" && <LogoCircle bg="#FF0000" size="w-5 h-5"><Youtube className="w-2.5 h-2.5" style={{ color: "#FFF" }} /></LogoCircle>}
                              </div>
                            ))}
                          </div>
                        </div>
                        ...
                        <div className="rounded-lg border p-2" style={{ borderColor: "var(--ch-border)", background: "var(--ch-surface)" }}>
                          <div className="flex items-center gap-2 mb-1">
                            ...
                            <span className="w-6 h-6 rounded-full flex items-center justify-center shrink-0" style={{ background: "linear-gradient(45deg, #f09433 0%, #e6683c 25%, #dc2743 50%, #cc2366 75%, #bc1888 100%)" }}>
                          ...
                          <p className="text-[7px] font-bold mb-0.5 flex items-center gap-1" style={{ color: "#00F2EA" }}><LogoCircle bg="#000000" size="w-3 h-3"><TikTokLogo size="w-2 h-2" /></LogoCircle> TikTok <span className="font-normal">(10)</span></p>
                        ...
                        <p className="text-[7px] font-bold mb-0.5 flex items-center gap-1" style={{ color: "#E1306C" }}><LogoCircle bg="linear-gradient(45deg, #f09433 0%, #e6683c 25%, #dc2743 50%, #cc2366 75%, #bc1888 100%)" size="w-3 h-3"><InstaLogo size="w-2 h-2" /></LogoCircle> Instagram <span className="font-normal">(5)</span></p>
                        ...
                        <div className="rounded-lg border p-2" style={{ borderColor: "var(--ch-border)", background: "var(--ch-surface)" }}>
                          ...
                          <p className="text-[7px] font-bold mb-0.5 flex items-center gap-1" style={{ color: "#00F2EA" }}><LogoCircle bg="#000000" size="w-3 h-3"><TikTokLogo size="w-2 h-2" /></LogoCircle> TikTok <span className="font-normal">(20)</span></p>
                        <div className="grid grid-cols-5 gap-1 mb-1.5">
                        ...
                        <p className="text-[7px] font-bold mb-0.5 flex items-center gap-1" style={{ color: "#E1306C" }}><LogoCircle bg="linear-gradient(45deg, #f09433 0%, #e6683c 25%, #dc2743 50%, #cc2366 75%, #bc1888 100%)" size="w-3 h-3"><InstaLogo size="w-2 h-2" /></LogoCircle> Instagram <span className="font-normal">(20)</span></p>
                        <div className="grid grid-cols-5 gap-1">
                          ...
                          {SKEMA_AMPLIFIERS.map((amp) => (
                            <div key={amp.platform} className="rounded-lg border p-3 text-center"
                              ...
                              <div className="flex items-center justify-center gap-1.5 mb-1">
                                {amp.platform === "Instagram" && <LogoCircle bg="linear-gradient(45deg, #f09433 0%, #e6683c 25%, #dc2743 50%, #cc2366 75%, #bc1888 100%)" size="w-5 h-5"><InstaLogo size="w-3 h-3" /></LogoCircle>}
                                {amp.platform === "TikTok" && <LogoCircle bg="#000000" size="w-5 h-5"><TikTokLogo size="w-3 h-3" /></LogoCircle>}
                                {amp.platform === "YouTube" && <LogoCircle bg="#FF0000" size="w-5 h-5"><Youtube className="w-3 h-3" style={{ color: "#FFF" }} /></LogoCircle>}
