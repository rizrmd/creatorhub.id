                        ...
                        <div className="grid grid-cols-3 gap-2">
                          {[
                            ...
                            <div className="flex items-center justify-center gap-1 mt-0.5">
                              {acc.name === "Menteri UMKM" && <><LogoCircle bg="linear-gradient(45deg, #f09433 0%, #e6683c 25%, #dc2743 50%, #cc2366 75%, #bc1888 100%)" size="w-4 h-4"><InstaLogo size="w-2.5 h-2.5" /></LogoCircle><span className="text-[9px] font-semibold" style={{ color: "#E1306C" }}>Instagram</span></>}
                              {acc.name === "Kementerian UMKM" && <><LogoCircle bg="linear-gradient(45deg, #f09433 0%, #e6683c 25%, #dc2743 50%, #cc2366 75%, #bc1888 100%)" size="w-4 h-4"><InstaLogo size="w-2.5 h-2.5" /></LogoCircle><span className="text-[9px] font-semibold" style={{ color: "#E1306C" }}>Instagram</span></>}
                              {acc.name === "Wakil Menteri UMKM" && <><LogoCircle bg="linear-gradient(45deg, #f09433 0%, #e6683c 25%, #dc2743 50%, #cc2366 75%, #bc1888 100%)" size="w-4 h-4"><InstaLogo size="w-2.5 h-2.5" /></LogoCircle><span className="text-[9px] font-semibold" style={{ color: "#E1306C" }}>Instagram</span></>}
                            </div>
