...
(async () => {
  ...
  // Login via API from the site context
  ...
  console.log('Login OK, token type:', typeof token, 'length:', token?.length);
  ...
  await page.screenshot({ path: 'heatmap-final4.png', fullPage: false });
